...
// Removed dead `require_role` function - cannot be used with Axum's middleware system
// Use specific role middleware (require_admin, require_chapter_lead) instead
