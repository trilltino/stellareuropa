...
pub fn create_auth_cookie(token: String, config: &Config) -> Cookie<'static> {
...
pub fn create_logout_cookie(config: &Config) -> Cookie<'static> {
...
pub fn get_token_from_cookies(cookies: &tower_cookies::Cookies, config: &Config) -> Option<String> {
